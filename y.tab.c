...
#define SETTK 265
#define REFTK 266
#define FOREIGNTK 267
#define PRIMARYTK 268
#define TYPEWITHOUTTK 269
#define TYPEWITHTK 270
#define IDTK 271
#define OPTK 272
#define NBTK 273
#define PARENTOUV 274
#define PARENTFERM 275
#define VIRGULE 276
#define POINTVIR 277
#define STRINGTK 278
...
enum yysymbol_kind_t
{
  ...
  YYSYMBOL_update_query = 27,              /* update_query  */
  YYSYMBOL_list_set_statement = 28,        /* list_set_statement  */
...
static const char *const yytname[] =
{
  ...
  "$accept", "query", "diff_query", "update_query", "list_set_statement",
  "set_statement", "values", YY_NULLPTR
};
...
{
      -8,   -14,     3,   -16,   -19,    -6,   -19,   -19,    -9,    -7,
     -13,   -19,   -18,    -9,   -19,   -19,   -19,   -13
};
...
{
      14,     1,     5,     6,     8,    15,     7,     9,    13,    17,
      12
};

static const yytype_int8 yycheck[] =
{
      18,     9,    16,     0,    10,    23,    22,    16,    21,    13,
      17
};
...
{
       0,     9,    25,    26,    27,    16,     0,    22,    10,    16,
      28,    29,    17,    21,    18,    23,    30,    28
};
...
yyreduce:
  ...
  switch (yyn)
    {
  case 2: /* query: diff_query POINTVIR  */
#line 40 "sql.y"
                          {yyaccept();}
#line 1189 "y.tab.c"
    break;

  case 7: /* set_statement: IDTK OPTK values  */
#line 48 "sql.y"
                               {
