...
enum yysymbol_kind_t
{
  ...
  YYSYMBOL_query = 25,                     /* query  */
  YYSYMBOL_diff_query = 26,                /* diff_query  */
  YYSYMBOL_create_query = 27,              /* create_query  */
  YYSYMBOL_column_list = 28,               /* column_list  */
  YYSYMBOL_column_def = 29,                /* column_def  */
  YYSYMBOL_Many_idtk = 30,                 /* Many_idtk  */
  YYSYMBOL_update_query = 31,              /* update_query  */
  YYSYMBOL_list_set_statement = 32,        /* list_set_statement  */
  YYSYMBOL_set_statement = 33,             /* set_statement  */
...
{
       0,    46,    46,    47,    49,    49,    51,    52,    53,    55,
      56,    57,    58,    59,    60,    62,    62,    63,    67,    67,
      69,    80,    80,    82
};
#endif
...
static const char *const yytname[] =
{
  ...
  "$accept", "query", "diff_query", "create_query", "column_list",
  "column_def", "Many_idtk", "update_query", "list_set_statement",
  "set_statement", "values", "END", YY_NULLPTR
};
...
{
      -3,     5,   -15,     3,   -10,   -25,   -25,    -2,     6,   -25,
     -25,    -3,    -6,    -1,   -25,    -8,     0,     1,   -25,     2,
       4,    -5,     7,     8,   -16,    -1,     9,    10,    11,    12,
     -25,    -8,   -25,   -25,   -25,   -25,    13,    14,    16,   -25,
      19,   -25,    17,    10,   -25,    18,    23,   -25,    21,    22,
     -25,    24,    25,   -25
};
...
{
       0,     0,     0,     0,     0,     5,     4,     0,     0,     1,
      23,     2,     0,     0,     3,     0,     0,    17,    19,     0,
       0,     0,     0,     8,     0,     0,     0,     0,     9,     0,
       6,     0,    22,    21,    20,    18,     0,    15,     0,    12,
       0,     7,     0,     0,    13,     0,     0,    16,    10,     0,
      11,     0,     0,    14
};
...
{
       1,     8,    32,     9,    19,    20,     2,    33,    21,    28,
      29,     7,    10,    15,    12,    16,    13,    24,    41,    47,
       0,    26,    25,    27,    39,    36,    37,    30,    46,    31,
       0,    40,     0,    42,    50,    43,    44,    45,    48,    49,
      52,    51,    14,     0,     0,    53,     0,     0,     0,     0,
       0,    35
};

static const yytype_int8 yycheck[] =
{
       3,    16,    18,     0,    12,    13,     9,    23,    16,    14,
      15,     6,    22,    19,    16,    16,    10,    17,    31,    43,
      -1,    19,    21,    19,    13,    16,    16,    20,    11,    21,
      -1,    19,    -1,    20,    13,    21,    20,    18,    20,    16,
      16,    19,    11,    -1,    -1,    20,    -1,    -1,    -1,    -1,
      -1,    25
};
...
{
       0,     3,     9,    25,    26,    27,    31,     6,    16,     0,
      22,    35,    16,    10,    25,    19,    16,    32,    33,    12,
      13,    16,    28,    29,    17,    21,    19,    19,    14,    15,
      20,    21,    18,    23,    34,    33,    16,    16,    30,    13,
      19,    28,    20,    21,    20,    18,    11,    30,    20,    16,
      13,    19,    16,    20
};
...
yyreduce:
  ...
  switch (yyn)
    {
  case 20: /* set_statement: IDTK OPTK values  */
#line 69 "sql.y"
                               {
